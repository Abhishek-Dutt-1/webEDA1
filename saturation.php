				...
				<section class="box">
					...
					<div style="clear: both;">
						<div id="chartContainer2">
							<h3 style="float:left;width:45%;">Saturation Curves</h3>
						...
						<div id="chartContainer3">
									...
									<div class='popboxCollapse'>
										<div class='popboxBox'>
											...
											<div style="margin: 25px;">
												<div id="saturationInputContainer"></div>
												<a href="#" class="button alt small" id="updateSaturationChart">Update</a>
							...
							<div id="saturationChartsContainer"></div>
